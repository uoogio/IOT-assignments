...
make -C tests/device01 clean all

iotlab-node --update tests/device01/bin/b-l072z-lrwan1/tests_device01.elf -l saclay,st-lrwan1,1
nc st-lrwan1-1 20000
loramac set deveui 00798A389B5DE075
